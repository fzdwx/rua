...
export function useApplications() {
  ...
  const handleLaunchApplication = useCallback(
    async (app: Application, actionId: string) => {
    ...
    () =>
      applications.map((app) => {
        ...
        return {
          ...
          icon: iconSrc ? (
            <img src={iconSrc} alt={app.name} className="size-6 object-contain" />
          ) : (
