        ...
        preferences: [
          {
            ...
            description: "Enable file system search in search results",
            type: "toggle",
            default: true,
          },
          {
            ...
            description: "Maximum number of file search results to display",
            type: "number",
            default: 20,
            min: 1,
            max: 100,
          ...
          },
          {
            ...
            description: "Minimum number of app/extension results before showing file search",
            type: "number",
            default: 5,
            min: 0,
            max: 50,
          ...
          },
          {
            name: "openMethod",
            title: "Open Method",
            description: "Method to open files when selected",
            type: "dropdown",
            default: "xdg-open",
            options: [
          ...
          {
            name: "customPaths",
            title: "Custom Search Paths",
            description: "Additional directories to search",
            type: "pathlist",
            default: [],
            validatePaths: true,
          },
