...
- **icon**: Icon identifier
  ...
  - Custom icons: `./path/to/icon.svg` or `./path/to/icon.png`
  - Data URIs: `data:image/svg+xml;base64,...`
  - Note: Relative paths (starting with `./`) are automatically converted to `ext://` protocol URLs for loading extension assets
